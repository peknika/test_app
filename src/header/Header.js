...
const Header = ({ onRandomClick, onSearch, searchInput, onSearchSubmit}) => (
    <nav className="navbar navbar-expand-sm">
        <button className="navbar-toggler custom-toggler" type="button" data-toggle="collapse" data-target="#beerMenu"
                aria-controls="beerMenu" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div className="collapse navbar-collapse" id="beerMenu">
            ...
            <form className="form-inline my-2 my-lg-0" onSubmit={onSearchSubmit}>
                <input className="form-control mr-sm-2" type="search" placeholder="Search" value={searchInput} aria-label="Search" onChange={onSearch} />
